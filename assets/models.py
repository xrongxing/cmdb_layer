...
class Asset(models.Model):
    ...
    name = models.CharField(max_length=64, unique=True, verbose_name='资产名称') # 资产名不重复
    sn = models.CharField(max_length=128, unique=True, verbose_name='资产序列号') # 序列号不重复
...
class Server(models.Model):
    ...
    os_distribution = models.CharField('发行版本', max_length=64, null=True, blank=True)
...
class SecurityDevice(models.Model):
    ...
    def __unicode__(self):
        return self.asset.name + '--' + self.get_sub_asset_type_dispaly() + ' id:%s' % self.id
...
class NetworkDevice(models.Model):
    ...
    vlan_ip = models.GenericIPAddressField(null=True, blank=True, verbose_name='VLan IP')
    ...
    device_detail = models.TextField(null=True, blank=True, verbose_name='设备详情')
